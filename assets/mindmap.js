/* mindmap.js - reusable knowledge-map layer for the learn-X-with-phoebe courses.
   ...
   window.MINDMAP_DATA = {
     ...
     centerColor: "#0B2545",
     sessions: [
       { label:"Frame & charter", href:"courses/01-...html", color:"#163E6A",
...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#163E6A");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#0B2545");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#A9C1DE");   // concept border
  var C_TINT   = theme("--indigo-50", "#E9F0F8");     // concept fill
  var C_INK    = theme("--ink", "#14202E");           // concept text
  var C_FAINT  = theme("--faint", "#C3CEDB");         // twig edges
